...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"512e47e3-80a0-4e93-ac2b-9f248d7fb0b2\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [24 x i8] c"com.companyname.jokeapp\00", align 16
...
@__DSOCacheEntry_name.36 = internal constant [22 x i8] c"libaot-JokeApp.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [458 x %struct.DSOCacheEntry] [
	...
	; 36
	%struct.DSOCacheEntry {
		i64 1738692463278813081, ; hash 0x182113955761ef99, from name: libaot-JokeApp.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.36, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 37
	%struct.DSOCacheEntry {
	...
	; 113
	%struct.DSOCacheEntry {
		i64 5117696263586673690, ; hash 0x4705b5a3136d741a, from name: libaot-JokeApp
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.36, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 189
	%struct.DSOCacheEntry {
		i64 8417597935936241112, ; hash 0x74d150b9718a7dd8, from name: aot-JokeApp
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.36, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 328
	%struct.DSOCacheEntry {
		i64 13357199329742354848, ; hash 0xb95e4e055b60f9a0, from name: JokeApp
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.36, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 409
	%struct.DSOCacheEntry {
		i64 16610192010054153648, ; hash 0xe68341a0ea4f35b0, from name: JokeApp.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.36, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 437
	%struct.DSOCacheEntry {
		i64 17925888365473557892, ; hash 0xf8c58c7e335bed84, from name: aot-JokeApp.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.36, i32 0, i32 0), ; name
		i8* null; handle
	}, 
